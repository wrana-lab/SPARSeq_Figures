...
nrow(vars_for_fig7_heatmap)#417
...
nrow(vars_for_fig7_heatmap) #359
...
srbmqs<-read.xlsx("processed_srbd_AA_overall_table_ForFig7.xlsx")
spbsqs<-read.xlsx("processed_spbs_aa_overall_table_forFig7.xlsx")
