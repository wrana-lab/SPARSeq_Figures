...
pilotsamples<-read.xlsx("nov2020tojan2021_pilotset_v4_sampleIDandRunIDs.xlsx")
head(pilotsamples)
...
#write.xlsx(firstfewmonths, file = "v26data_pilotset_forheatmap.xlsx")
#firstfewmonths<-read.xlsx("v26data_pilotset_forheatmap.xlsx")
...
pdf("pilotsamples_withnegatives_countHeatmaps_log10actb-norm_byRBDscore_v26.pdf", height = 4, width = 20)
heatmap4
dev.off()
