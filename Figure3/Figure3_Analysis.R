...
#save file
write.xlsx(data_for_hm_perday, file="data_for_hm_perDAY_PROPORTION_crunchedDataForCompetitions_v26dataset.xlsx")
...
data_for_hm_perday<-read.xlsx("data_for_hm_perDAY_PROPORTION_crunchedDataForCompetitions_v26dataset.xlsx")
