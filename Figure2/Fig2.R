...
pdf("combined_weekly_data_v26Data_PlusIncorporatedIntoNormalLines.pdf", width = 18, height = 6 )
overallplot1Av3
dev.off()
...
pdf("combined_weekly_data_v26_Cappedat1000.pdf", width = 18, height = 6 )
overallplot1_capped2k
dev.off()
...
#write.xlsx(data_for_hm_perweek, "percents_per_week_v26data_v1.xlsx")
...
head(data_for_hm_perweek, 12)
write.xlsx(data_for_hm_perweek, "percents_per_week_vocAndvocPluscombined_Datav26.xlsx")
