...
subvarlist_forplot<-read.xlsx("organized_subvariants_v26.xlsx")
...
write.xlsx(submainlist, file = "samples_in_heatmap_Supp8v26data.xlsx")
write.xlsx(subvarlist_forplot, file = "variants_in_heatmap_Supp8v26.xlsx")
submainlist<-read.xlsx("samples_in_heatmap_Supp8v26data.xlsx")
subvarlist_forplot<-read.xlsx("variants_in_heatmap_Supp8v26.xlsx")
...
write.xlsx(allcompiled_for8, file = "SuppFig8_v26_fullheatmapdataset.xlsx")
allcompiled_for8<-read.xlsx("SuppFig8_v26_fullheatmapdataset.xlsx")
...
pdf("suppFig8_v26black.pdf", width = 10, height = 22)
figSupp8black
dev.off()
...
pdf("suppFig8_v26gray.pdf", width = 10, height = 22)
figSupp8gray
dev.off()
