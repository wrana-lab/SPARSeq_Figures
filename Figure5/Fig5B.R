...
##import v26 data
alldatareload<-read.xlsx("filtered_data_for_paper_v26.xlsx")
alldatareload$Date.of.collection <- as.Date(alldatareload$Date.of.collection, 
...
write.xlsx(allsubvar, file="AllSubvariants_v26.xlsx")
...
write.xlsx(data_for_bp, "organized_subvariants_v26.xlsx")


###Begin bar plot of residue categories####
##Get top subvariants
subvarlist<-read.xlsx("organized_subvariants_v26.xlsx")
...
nrow(subvarlist_cut) #14 variants
subvarlist_cut$Variant.Details
write.xlsx(subvarlist_cut, "top14_subvariants_v26data.xlsx")
...
subvarlist<-read.xlsx("top14_subvariants_v26data.xlsx")
head(subvarlist)
...
#write.xlsx(subsetdata, file = "Top14SubvariantHeatmap_daysSinceFirstCaseOfSubvariant_v26data.xlsx")
subsetdata<-read.xlsx("Top14SubvariantHeatmap_daysSinceFirstCaseOfSubvariant_v26data.xlsx")
...
#write.xlsx(submainlist_agg, "Top14SubvariantHeatmap_forMADcalc_v26data.xlsx")
submainlist_agg<-read.xlsx("Top14SubvariantHeatmap_forMADcalc_v26data.xlsx")
...
#then reloaded
forbarplot5b<-read.xlsx("MedianDaysSince1stCase_categorized_v26.xlsx")
...
forbarplot5b_plot
pdf("forbarplot5b_plot_median_v26.pdf", width=5,height=4)
forbarplot5b_plot
dev.off()

#Median of median values per category
median(forbarplot5b[forbarplot5b$Category == "Other residue(s)",]$medianN) #29
median(forbarplot5b[forbarplot5b$Category == "Variant-defining residue(s)",]$medianN) #64.5
...
#write.xlsx(submainlist_agg, file = "data_for_heatmap5b_v26data.xlsx")
submainlist_agg<-read.xlsx("data_for_heatmap5b_v26data.xlsx")
...
pdf("heatmap5B_timebased_topsubvariants_datav26.pdf", width = 8, height = 4)
keysubvar_plot_all
dev.off()
