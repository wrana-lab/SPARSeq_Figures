...
#write.xlsx(srbdtable_x2, file="srbd_AAs_by_main_variant_v26.xlsx")
...
#write.xlsx(spbstable_x2, file="spbs_AAs_by_main_variant_v26.xlsx")
...
#write.xlsx(rdrptable_x2, file="rdrp_AAs_by_main_variant_v26.xlsx")
...
write.xlsx(list_of_datasets, file = "minor_mutation_data_v26_includesWT+.xlsx")
...
#srbd
srbd_for_bp<-read.xlsx("minor_mutation_data_v26_includesWT+.xlsx", sheet = "SRBD")
...
pdf("srbm_position_heatmap_normalizedtoVariantCases_v26_red_border_noncanonical.pdf", height = 3, width = 7)
srbm_noncanonical
dev.off()


####spbs####
spbs_for_bp<-read.xlsx("minor_mutation_data_v26_includesWT+.xlsx", sheet = "SPBS")
...
pdf("spbs_position_heatmap_normalizedtoVariantCases_v26_red_border_noncanonical_capped.pdf", height = 3.5, width = 7)
spbssrbd_noncanonical_cap
dev.off()
