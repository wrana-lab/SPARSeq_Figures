...
pilot<-read.xlsx("v26data_pilotset_forheatmap.xlsx")
...
pdf("VariantHeatmap1_AllVariantsBinarized_datav26_orderedbyDate.pdf", height = 17, width = 17)
hm_4c
dev.off()
...
pdf("WT_weekly_data_v26Data.pdf", width = 8, height = 4 )
pairgraph_WT2
dev.off()
...
pdf("alpha_weekly_data_v26Data.pdf", width = 8, height = 4 )
pairgraph_alpha2
dev.off()
...
pdf("delta_weekly_data_v26Data_separate.pdf", width = 8, height = 4 )
pairgraph_delta2
dev.off()
...
pdf("omicron_weekly_data_v26Data.pdf", width = 8, height = 4 )
pairgraph_omicron2
dev.off()
...
pdf("omicronBA23_weekly_data_v26Data.pdf", width = 8, height = 4 )
pairgraph_omicron2
dev.off()
...
pdf("omicronBA45_weekly_data_v26Data.pdf", width = 8, height = 4 )
pairgraph_omicron2
dev.off()
